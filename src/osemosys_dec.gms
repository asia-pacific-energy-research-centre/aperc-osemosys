...
parameter DaySplit(DAILYTIMEBRACKET,YEAR);
...
parameter DaysInDayType(SEASON,DAYTYPE,YEAR);
...
* ######## Storage Parameters #############
*
* the index order is out of order:
...
* ############### Capacity Variables ############
*
positive variable NumberOfNewTechnologyUnits(REGION,TECHNOLOGY,YEAR);
...
free variable OperatingCost(REGION,TECHNOLOGY,YEAR);
free variable DiscountedOperatingCost(REGION,TECHNOLOGY,YEAR);

*
*positive variable AnnualVariableOperatingCost(REGION,TECHNOLOGY,YEAR);  # 
free variable AnnualVariableOperatingCost(REGION,TECHNOLOGY,YEAR);
...
free variable TotalDiscountedCostByTechnology(REGION,TECHNOLOGY,YEAR);
