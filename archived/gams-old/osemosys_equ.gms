...
S1_RateOfStorageCharge(r,s,ls,ld,lh,y)..  sum((t,m,l)$(TechnologyToStorage(r,t,s,m)>0), RateOfActivity(r,l,t,m,y) * TechnologyToStorage(r,t,s,m) * Conversionls(l,ls) * Conversionld(l,ld) * Conversionlh(l,lh)) =e= RateOfStorageCharge(r,s,ls,ld,lh,y);
...
S2_RateOfStorageDischarge(r,s,ls,ld,lh,y)..  sum((t,m,l)$(TechnologyFromStorage(r,t,s,m)>0),RateOfActivity(r,l,t,m,y) * TechnologyFromStorage(r,t,s,m) * Conversionls(l,ls) * Conversionld(l,ld) * Conversionlh(l,lh)) =e= RateOfStorageDischarge(r,s,ls,ld,lh,y);
...
S4_NetChargeWithinDay(r,s,ls,ld,lh,y).. (RateOfStorageCharge(r,s,ls,ld,lh,y) - RateOfStorageDischarge(r,s,ls,ld,lh,y)) * DaySplit(lh,y) =e= NetChargeWithinDay(r,s,ls,ld,lh,y);
...
S12_StorageLevelDayTypeStart(r,s,ls,ld,y)$(ord(ld) > 1).. StorageLevelDayTypeStart(r,s,ls,ld-1,y) + sum(lh, NetChargeWithinDay(r,s,ls,ld-1,lh,y) * DaysInDayType(ls,ld-1,y) )  =e=  StorageLevelDayTypeStart(r,s,ls,ld,y);
...
S15_StorageLevelDayTypeFinish(r,s,ls,ld,y)$(smax(ldld,ld.val) and not smax(lsls,ls.val)).. StorageLevelDayTypeFinish(r,s,ls,ld+1,y) - sum(lh,  NetChargeWithinDay(r,s,ls,ld+1,lh,y)  * DaysInDayType(ls,ld+1,y) ) =e= StorageLevelDayTypeFinish(r,s,ls,ld,y);
*
* ######### Storage Constraints #############
*
...
*s.t. AAC2_TotalAnnualTechnologyActivityUpperLimit{r in REGION, t in TECHNOLOGY, y in YEAR}: TotalTechnologyAnnualActivity[r,t,y] <= TotalTechnologyAnnualActivityUp[r,t,y] ;
equation AAC2_TotalAnnualTechnologyActivityUpperLimit(REGION,TECHNOLOGY,YEAR);
AAC2_TotalAnnualTechnologyActivityUpperLimit(r,t,y).. TotalTechnologyAnnualActivity(r,t,y) =l= TotalTechnologyAnnualActivityUp(r,t,y);
